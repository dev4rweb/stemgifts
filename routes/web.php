...
Route::post('/twitter/reposted-post', [SocialTwitterController::class, 'getRepostedPost']);
...
Route::post('/twitter/view-twitter-post', [SocialTwitterController::class, 'viewTwitterPost']);
